    ...
    <div className="min-h-screen px-4 py-8 sm:py-10">
      <div className="max-w-2xl mx-auto w-full">
        ...
        <div className="text-center mb-8 animate-fadeInUp">
          ...
          <p className="text-green-200 text-xs sm:text-sm">
            Upload a photo — AI identifies crop, detects diseases & shows live prices
          </p>
        </div>
        ...
        {!result && (
          <div className="animate-fadeInUp">
                ...
                <>
                  ...
                  {loading && (
                    <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center z-30">
                      ...
                      <p className="text-green-400 font-semibold mt-4 text-sm animate-pulse">
                        {SCAN_STEPS[stepIdx]}
                      </p>
                        ...
                        {SCAN_STEPS.map((_, i) => (
                          <div
                            ...
                            className={`h-1 w-6 rounded-full transition-all duration-300 ${
                              i <= stepIdx ? 'bg-green-400' : 'bg-white/20'
                            }`}
                          />
                        ))}
                      </div>
                  ...
                  {!loading && (
                    <button
                      ...
                      className="absolute top-3 right-3 z-20 bg-black/60 hover:bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center"
                    >
                      ×
                    </button>
                  )}
            ...
            {preview && !loading && (
              <button
                onClick={handleScan}
                className="mt-4 w-full shimmer-btn text-white font-bold py-4 rounded-2xl text-lg"
              >
                🔍 Scan This Crop
              </button>
            )}
